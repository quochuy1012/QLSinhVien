    ...
    public partial class Form1 : Form
    {
        ...
        private void StudentLoad(List<Student> students)
        {
            ...
            foreach (var item in students)
            {
                ...
                dtgv_ThongTin.Rows[index].Cells[3].Value = Math.Round(item.AverageScore,2);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            var student = new Student
            {
                ...
                AverageScore = float.Parse(txb_Diem.Text.ToString().Replace('.', ',')),
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (timSV != null)
                {
                    ...
                    timSV.AverageScore = float.Parse(txb_Diem.Text.ToString().Replace('.', ','));
